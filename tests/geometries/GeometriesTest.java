...
class GeometriesTest {
    ...
    void testFindIntersections(){
        ...
        assertEquals(null,geo2.findIntersections(ray2),"ERROR: empty geometries collection,it must return null ");
        ...
        assertEquals(null,intersectionPoints3,"ERROR, there are no intersection points, therefore it must return null");
        ...
        assertEquals(3,geo3.findIntersections(ray5).size(), "ERROR, there must be three one intersection point");

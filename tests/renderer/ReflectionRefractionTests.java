...
public class ReflectionRefractionTests {
    ...
    public void twoSpheresOnMirrors2() {
        ...
        Render render = new Render() //
                .setImageWriter(imageWriter) //
                .setCamera(camera) //
                .setRayTracer(new BasicRayTracer(scene).set_numOfRays(5).setRadius(2).set_rayDistance(2));
    ...
    @Test
    public void ImageWithFourObjects() {
        ...
        scene.geometries.add( //
                ...
                new Triangle(new Point3D(-150, -150, -115), new Point3D(-70, 70, -140), new Point3D(75, 75, -150)) //
                        .setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(60)), //
                new Sphere(30, new Point3D(60, 30, -50)) //
                        .setEmission(new Color(java.awt.Color.BLUE)) //
                        .setMaterial(new Material().setKd(0.2).setKs(0.2).setShininess(30).setKt(0.6)),
                 new Sphere(15, new Point3D(60, 30, -50)) //
                .setEmission(new Color(java.awt.Color.cyan))
                .setMaterial(new Material().setKd(0.2).setKs(0.2).setShininess(30)));

        scene.lights.add(new SpotLight(new Color(700, 400, 400), //
                new Point3D(60, 50, 0), new Vector(0, 0, -1)).setKl(4E-5).setKq(2E-7));

        ImageWriter imageWriter = new ImageWriter("ImageWith4Objects", 600, 600);
        Render render = new Render() //
                .setImageWriter(imageWriter) //
                .setCamera(camera) //
                .setRayTracer(new BasicRayTracer(scene));
